        ...
        <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
            ...
            <div className="divide-y divide-gray-300">
                ...
                <div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
                    ...
                    <p className="md:pl-0 md:col-span-7"> <strong>React: </strong> It's used for building interactive user interfaces and web applications quickly and efficiently with significantly less code than you would with vanilla JavaScript. In React, you develop your applications by creating reusable components that you can think of as independent Lego blocks.
                    <br />
                    <br />
                    <strong>Angular:</strong> This topic can help you understand Angular: what Angular is, what advantages it provides, and what you might expect as you start to build your applications.
                    A component-based framework for building scalable web applications.
                    </p>
                    <br />
                    <br />
                    <p> <strong>Vue:</strong> Vue is a JavaScript framework for building user interfaces. It builds on top of standard HTML, CSS, and JavaScript and provides a declarative and component-based programming model that helps you efficiently develop user interfaces, be they simple or complex.</p>
                </div>
            </div>
        </div>
    </section>
