	...
	<div className="container flex flex-col items-center justify-center mx-auto sm:p-10">
		...
		<div className="flex flex-row flex-wrap-reverse justify-center mt-8">
			<div className="flex flex-col hover:-translate-y-6 duration-500 hover:shadow-2xl justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-800 hover:bg-white hover:text-gray-800 text-gray-100">
				...
				<img alt="" className="hover:scale-125 ease-liner duration-200 self-center flex-shrink-0 w-28 h-28 -mt-12 bg-center bg-cover rounded-full bg-gray-500" src="https://source.unsplash.com/100x100/?portrait?0" />
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">Harry</p>
					<p>Front-End Developer</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="">
			...
			<div className="flex flex-col hover:-translate-y-6 duration-500 hover:shadow-2xl justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-800 hover:bg-white hover:text-gray-800 text-gray-100">
				...
				<img alt="" className="hover:scale-125 ease-liner duration-200 self-center flex-shrink-0 w-28 h-28 -mt-12 bg-center bg-cover rounded-full bg-gray-500" src="https://source.unsplash.com/100x100/?portrait?1" />
				<div className="flex-1 my-4">
			...
			<div className="flex flex-col hover:-translate-y-6 duration-500 hover:shadow-2xl justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-800 hover:bg-white hover:text-gray-800 text-gray-100">
				...
				<img alt="" className="hover:scale-125 ease-liner duration-200 self-center flex-shrink-0 w-28 h-28  -mt-12 bg-center bg-cover rounded-full bg-gray-500" src="https://source.unsplash.com/100x100/?portrait?2" />
				<div className="flex-1 my-4">
